...
class AlphaIntraExample(ExprScriptBase):
    def __init__(self, cfg):
        ...
        self.stdret = dr.GetData('Intervalorderaskpriceunequal.stdret')
        self.skewvolratio = dr.GetData('Intervalorderaskpriceunequal.skewvolratio')
        self.skewret = dr.GetData('Intervalorderaskpriceunequal.skewret')
        self.avgret = dr.GetData('Intervalorderaskpriceunequal.avgret')
        self.stdvolratio = dr.GetData('Intervalorderaskpriceunequal.stdvolratio')
        self.avgflag = dr.GetData('Intervalorderaskpriceunequal.avgflag')
