...
class AlphaIntraExample(ExprScriptBase):
    def __init__(self, cfg):
        ...
        self.iter1 = dr.GetData("Intervaldetailbidaskcrossstats.sumask1buy")
        self.iter2 = dr.GetData("Intervalbidask12stats.skewask12")
    ...
    def DailyRun(self, di):
        ...
        para1 = self.iter1[di-1680][:]
        para2 = self.iter2[di-1680][:]
