...
class AlphaIntraExample(ExprScriptBase):
    def __init__(self, cfg):
        ...
        self.iter1 = dr.GetData("Intervalopenstats1.mean_buyOrderNum")
        self.iter2 = dr.GetData("Intervalopenstats1.buy_vol")
        self.iter3 = dr.GetData("Intervalopenstats1.buyorderskew")
    ...
    def DailyRun(self, di):
        ...
        para1 = self.iter3[di-1680][1:61][0:uv.instsz]
